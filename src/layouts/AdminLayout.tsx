...
import { AppstoreOutlined, SolutionOutlined, PieChartOutlined, HomeOutlined, UserOutlined } from "@ant-design/icons";
...
const items: MenuItem[] = [
    ...
    getItem("Comment", "sub4", <SolutionOutlined />, [getItem(<Link to={"/admin/comment"}>Comment List</Link>, "6")]),
    getItem(<Link to={"/admin/payment"}>Payment</Link>, "sub5", <SolutionOutlined />),
    getItem(<Link to={"/admin/booking"}>Booking</Link>, "sub6", <SolutionOutlined />),
];
const AdminLayout = () => {
