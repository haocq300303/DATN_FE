...
import { createPostMid, updatePostMid, deletePostMid, getAllPostMid, setData } from '../../../../Redux/Slices/postSlice';
    ...
    <>
      ...
      <ModalForm isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} form={form} modalMode={modalMode}>
        <Form form={form} {...layout} name="nest-messages" onFinish={onFinish} validateMessages={validateMessages} layout="vertical">
          ...
          <Form.Item name="title" label="Tiêu Đề" rules={[{ required: true }, { whitespace: true, message: '${label} chưa nhập!' }]}>
          ...
          <Form.Item name="description" label="Miêu Tả" rules={[{ required: true }, { whitespace: true, message: '${label} chưa nhập!' }]}>
            {/* <Input.TextArea rows={4} placeholder="Miêu tả" /> */}
            <ReactQuill className="mb-10 h-[150px]" />
          </Form.Item>
        </Form>
      </ModalForm>
    </>
