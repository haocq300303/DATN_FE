    ...
    <div>
      <div className="flex justify-between">
        <h1 className="text-[20px]">
          Sân Bóng Của Bạn : <span className="font-[600] text-blue-500 italic">{pitchs?.name}</span>
        </h1>
        ...
        <div className="flex justify-between w-full mt-[20px]">
          <div className=" w-full">
            ...
            <div className="text-[18px] pl-[100px] pt-[20px]">
              <p className="py-[5px]">
                Chủ Sở Hữu : <span className="italic text-gray-700">{pitchs?.admin_pitch_id?.name || pitchs?.admin_pitch_id?.email}</span>
              </p>
              <p className="py-[5px]">
                Vị trí tìm kiếm : <span className="italic text-gray-700">{pitchs?.address}</span>
              </p>
              <p className="py-[5px]">
                Số lượng sân : <span className="italic text-gray-700">{pitchs?.numberPitch} sân</span>
              </p>
              <p className="py-[5px]">
                Giá tiền giao động :{' '}
              ...
              <p className="py-[5px]">
                Ngày tạo sân : <span className="italic text-gray-700">{pitchs?.createdAt}</span>
              </p>
              <p className="py-[5px]">
                Ngày cập nhật sân gần nhất : <span className="italic text-gray-700">{pitchs?.updatedAt}</span>
              </p>
              ...
              <p className="py-[5px] w-[500px]">
                Miêu tả sân : <span className="italic w-[200px] text-gray-700"> {pitchs?.description}</span>
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="w-1/2">
            ...
            <Form.Item name="numberPitch" label="Số Lượng Sân" rules={[{ required: true, type: 'number', min: 0 }]}>
              <InputNumber size="large" placeholder="Số Lượng Sân" style={{ width: '100%' }} />
            </Form.Item>
