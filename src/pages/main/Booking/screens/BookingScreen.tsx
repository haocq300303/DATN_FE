            ...
            <section>
                ...
                <div className="md:flex items-center">
                    <div className="w-full md:w-[300px] md:min-w-[300px] h-[300px]">
                        <img src={infoBooking?.pitch_avatar} alt="Ảnh sân bóng" className="w-full rounded-md" />
                    </div>
                    ...
                    <div className="mt-2 md:mt-0 flex-1 md:ml-10 space-y-2 md:space-y-4 text-base md:text-lg">
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <span className="flex-1 text-[#242424]">{infoBooking?.booking_day}</span>
                        </div>
                        <div className="flex flex-wrap">
                            <div className="text-[#422eb1] font-semibold mr-3 flex justify-between w-[100px]">
                                Chủ sân <span>:</span>{" "}
                            </div>
                            <span className="flex-1 text-[#242424]">{infoBooking?.admin_pitch_name}</span>
                        </div>
                        <div className="flex flex-wrap">
                            <div className="text-[#422eb1] font-semibold mr-3 flex justify-between w-[100px]">
                                Số đt <span>:</span>{" "}
                            </div>
                            <span className="flex-1 text-[#242424]">{infoBooking?.admin_pitch_phone}</span>
                        </div>
                    </div>
                </div>
            </section>
