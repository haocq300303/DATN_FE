    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const _infoBooking = {
          ...
          price_received:
            modeBanking === 1 ? infoBooking?.price : infoBooking?.price * 0.2,
    ...
    <div className="border border-solid px-5 py-2 rounded-md border-[#e7e7e7]">
        ...
        <div className="flex justify-between items-center">
          ...
          >
            ...
            <Radio value={2} className="text-base">
              Đặt cọc (20%) - ({(infoBooking?.price * 0.2)?.toLocaleString()}{" "}
              VNĐ)
            </Radio>
          </Radio.Group>
      ...
      <section>
        ...
        <div className="text-base">
          Chi phí hủy sân là 10% số tiền cọc sân trước đó
        </div>
      </section>
