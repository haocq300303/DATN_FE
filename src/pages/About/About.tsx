      ...
      <div className='container mx-auto max-w-screen-2xl pt-28 relative'>
        <Row className='bg-white '>
              ...
              <div className="box-intro-about ">
                <div className="box-intro-text mr-24">
                  <h2 className="text-[32px] uppercase font-bold text-lime-50 sm:text-[40px] lg:text-[36px] xl:text-[30px] pb-6 flex">
                    <div className='bg-black text-black py-3 w-1 '></div><span className='bg-lime-600 py-3'>Chào mừng bạn đến với club   </span>
                  </h2>
                  <p>
          ...
          <Col span={12}>
            <Carousel autoplay>
              <div>
                <img src="https://res.cloudinary.com/dqyffo8rx/image/upload/v1697301913/DATN/slide-1_dvhmph.jpg" style={contentStyle} alt="" />
              </div>
              <div>
                <img src="https://res.cloudinary.com/dqyffo8rx/image/upload/v1697301913/DATN/slide-2_wcipdv.jpg" style={contentStyle} alt="" />
              </div>
              <div>
                <img src="https://res.cloudinary.com/dqyffo8rx/image/upload/v1697301912/DATN/slide-3_ce9aan.jpg" style={contentStyle} alt="" />
              </div>
            </Carousel>
          </Col>
        </Row>
              ...
              <div className="box-row pl-[15%] py-12">
                <Row gutter={16} className='w-[100%] ' >
                  <Col className="gutter-row" span={6}>
                    ...
                    <div className="relative w-20 h-20 bg-lime-800 rounded-full flex justify-center items-center text-center p-4 shadow-xl cursor-pointer transition  hover:scale-[1.1] hover:bg-lime-600 " onClick={() => onChange(0)}>
                      <span className="absolute text-7xl left-0 top-0 text-lime-400">"
                      </span>
                      <h5 className=" uppercase font-bold text-white  text-center ">
                        1
                      </h5>
                    </div>
                  ...
                  <Col className="gutter-row" span={6}>
                    <div className="relative w-20 h-20 bg-lime-800 rounded-full flex justify-center items-center text-center p-4 shadow-xl cursor-pointer transition  hover:scale-[1.1] hover:bg-lime-600 " onClick={() => onChange(1)}>
                      <span className="absolute text-7xl left-0 top-0 text-lime-400">"
                      </span>
                      <h5 className=" uppercase font-bold text-white  text-center ">
                        2
                  ...
                  <Col className="gutter-row" span={6}>
                    <div className="relative w-20 h-20 bg-lime-800 rounded-full flex justify-center items-center text-center p-4 shadow-xl cursor-pointer transition  hover:scale-[1.1] hover:bg-lime-600 " onClick={() => onChange(2)}>
                      <span className="absolute text-7xl left-0 top-0 text-lime-400">"
                      </span>
                      <h5 className=" uppercase font-bold text-white  text-center ">
                        3
                  ...
                  <Col className="gutter-row" span={6}>
                    <div className="relative w-20 h-20 bg-lime-800 rounded-full flex justify-center items-center text-center p-4 shadow-xl cursor-pointer transition  hover:scale-[1.1] hover:bg-lime-600 " onClick={() => onChange(3)}>
                      <span className="absolute text-7xl left-0 top-0 text-lime-400">"
                      </span>
                      <h5 className=" uppercase font-bold text-white  text-center ">
                        4
            ...
            <Carousel ref={carouselRef} className='  '  >
              <div className='pl-32'>
                <div className='flex gap-10 w-[90%] border p-6 '>
                  <img src="https://res.cloudinary.com/dqyffo8rx/image/upload/v1697301970/DATN/history-1_t1jxw9.jpg" alt="" className='w-80' />
                  <p >
        ...
        <div className="video-about-end">
          ...
          <div className="video-youtube flex justify-center  ">
            <iframe width="1190" height="445" src="https://www.youtube.com/embed/oHdg9H6CdOE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </div>
        </div>
      </div>
